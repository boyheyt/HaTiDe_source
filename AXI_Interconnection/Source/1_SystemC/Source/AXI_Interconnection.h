...
// start end
const sc_dt::sc_uint<C_S_AXI_ADDR_WIDTH> PRAM_StartAddress[PRAM_SLAVE_NUM] = {0x000000000};

const sc_dt::sc_uint<C_S_AXI_ADDR_WIDTH> PRAM_EndAddress[PRAM_SLAVE_NUM] = {0x00000FFFFF};
