...
//Date        : Thu Sep  3 00:24:45 2020
//Host        : NTX-PC running 64-bit Service Pack 1  (build 7601)
...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (ColDataOut,
    DDR_addr,
    DDR_ba,
  ...
  wire [3:0]KeyPadInterpreter_0_ColDataOut;
  wire [8:0]KeyPadInterpreter_0_DataOut;
  wire KeyPadInterpreter_0_KeyReady;
  wire [3:0]KeyPadInterpreter_0_PressCount;
  wire Push_button_1;
  ...
  assign ColDataOut[3:0] = KeyPadInterpreter_0_ColDataOut;
  assign PressCount[3:0] = KeyPadInterpreter_0_PressCount;
  assign Push_button_1 = Push_button;
  assign RowDataIn_1 = RowDataIn[3:0];
  assign d[7:0] = top_0_d;
  assign e = top_0_e;
  assign rs = top_0_rs;
  design_1_KeyPadInterpreter_0_0 KeyPadInterpreter_0
       (.Clock(processing_system7_0_FCLK_CLK0),
        .ColDataOut(KeyPadInterpreter_0_ColDataOut),
        .DataOut(KeyPadInterpreter_0_DataOut),
        .KeyRead(top_0_done),
        .KeyReady(KeyPadInterpreter_0_KeyReady),
        .PressCount(KeyPadInterpreter_0_PressCount),
  ...
  design_1_top_0_0 top_0
       (.clock_100(processing_system7_0_FCLK_CLK0),
        .d(top_0_d),
        .data_in(KeyPadInterpreter_0_DataOut),
        .done(top_0_done),
        .e(top_0_e),
        .enable_in(KeyPadInterpreter_0_KeyReady),
