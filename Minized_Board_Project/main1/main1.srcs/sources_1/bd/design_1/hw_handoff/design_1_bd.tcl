...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ColDataOut [ create_bd_port -dir O -from 3 -to 0 ColDataOut ]
  set Push_button [ create_bd_port -dir I Push_button ]
  set RowDataIn [ create_bd_port -dir I -from 3 -to 0 -type intr RowDataIn ]
  set_property -dict [ list \
   CONFIG.PortWidth {4} \
   CONFIG.SENSITIVITY {EDGE_FALLING} \
 ] $RowDataIn
  set d [ create_bd_port -dir O -from 7 -to 0 d ]
  ...
  if { [catch {set KeyPadInterpreter_0_upgraded_ipi [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net KeyPadInterpreter_0_upgraded_ipi_ColDataOut [get_bd_ports ColDataOut] [get_bd_pins KeyPadInterpreter_0_upgraded_ipi/ColDataOut]
  connect_bd_net -net KeyPadInterpreter_0_upgraded_ipi_DataOut [get_bd_pins KeyPadInterpreter_0_upgraded_ipi/DataOut] [get_bd_pins ila_0/probe2] [get_bd_pins top_0/data_in]
  connect_bd_net -net KeyPadInterpreter_0_upgraded_ipi_KeyReady [get_bd_pins KeyPadInterpreter_0_upgraded_ipi/KeyReady] [get_bd_pins ila_0/probe0] [get_bd_pins top_0/enable_in]
  connect_bd_net -net Push_button_1 [get_bd_ports Push_button] [get_bd_pins KeyPadInterpreter_0_upgraded_ipi/ResetButton] [get_bd_pins top_0/push_button]
